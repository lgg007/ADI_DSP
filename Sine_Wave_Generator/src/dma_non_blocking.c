...
void WelcomeMessage(void)
{
    ...
    DEBUG(1,""_VTAB_"");
    DEBUG(1,"\n");
    DEBUG(1, "Sine Wave Generator with adjustable frequency!" _NL_ "");
    ...
    DEBUG(1, "freq up         (Turns sine wave Frequency Up)" _NL_ "");
    DEBUG(1, "freq dn         (Turns sine wave Frequency Down)" _NL_"");
