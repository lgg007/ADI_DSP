...
Created signal generator routine
...
void init_SPORT_DMA2(void)
{
    // SPORT0_A DMA Initialization
    *pREG_DMA0_CFG       = 0x00001220;      // SPORT0 TX, FLOW = autobuffer, MSIZE = PSIZE = 4 bytes
    *pREG_DMA0_ADDRSTART = iTxBuffer1;     // points to start of SPORT0_A buffer
    *pREG_DMA0_XCNT      = 2*INPUT_SIZE;     // no. of words to transmit
    *pREG_DMA0_XMOD      = 4;               // stride
    *pREG_DMA0_YCNT 	 = TOTAL_FRAME;
    *pREG_DMA0_YMOD      = 4;

    // SPORT0_B DMA Initialization
    *pREG_DMA1_CFG       = 0x00101222;      // SPORT0 RX, DMA interrupt when x count expires
    *pREG_DMA1_ADDRSTART = iRxBuffer1;     // points to start of SPORT0_B buffer
    *pREG_DMA1_XCNT      = 2*INPUT_SIZE;     // no. of words to receive
    *pREG_DMA1_XMOD      = 4;               // stride
    *pREG_DMA1_YCNT 	 = TOTAL_FRAME;
    *pREG_DMA1_YMOD      = 4;
}
