...
src/patrick_flasher.doj: ../src/patrick_flasher.asm
	...
	easmblkfn -file-attr ProjectName="Harmonic_Signal_Generator" -proc ADSP-BF706 -si-revision 1.1 -g -D_DEBUG -DCORE0 @includes-907392110242762aecc03defbeb20116.txt -gnu-style-dependencies -MM -Mo "src/patrick_flasher.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
