...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="Harmonic_Signal_Generator" -proc ADSP-BF706 -si-revision 1.1 -g -D_DEBUG -DCORE0 @includes-907392110242762aecc03defbeb20116.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
